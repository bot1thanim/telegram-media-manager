...
class AuditAction:
    ...
    TOPIC_SYNC_STARTED = "TOPIC_SYNC_STARTED"
    TOPIC_SYNC_COMPLETED = "TOPIC_SYNC_COMPLETED"
    TARGET_TOPIC_CREATED = "TARGET_TOPIC_CREATED"
    TOPIC_BROADCAST_STARTED = "TOPIC_BROADCAST_STARTED"
    TOPIC_BROADCAST_COMPLETED = "TOPIC_BROADCAST_COMPLETED"
